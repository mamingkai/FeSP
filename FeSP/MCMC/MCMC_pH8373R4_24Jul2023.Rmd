...
data_choice <- 8  # experimental dataset
sens_factor <- 2
...
```{r}
DATA_8373r4 <-DATA <- getExpData(data_choice)  # load experimental data
...
```{r plots}
summary_sR_8373r4 <- as.data.frame(summary(sR))
plot_sens_S <- fun_plot_sens_SP(summary_sR_8373r4,obs = DATA_8373r4,species = "S")+theme_bw()
plot_sens_P <- fun_plot_sens_SP(summary_sR_8373r4,obs = DATA_8373r4,"P")+theme_bw()

plot_sens_conc <- fun_plot_sens_others(df = summary_sR_8373r4,species = c("Fe","Sads", "Pads.fast","Pads.slow"),num_cols = 2,plot=F)
plot_sens_rates <- fun_plot_sens_others(df = summary_sR_8373r4,species = c("R.Fe","R.Pads", "R.Pdes.fast","R.Pdes.slow","R.Pdes.stoi","RHS.fast","RHS.slow","R.Sads","R.Sdes"),num_cols = 3,plot=F)
...
plot_sens_S_8373r4 <- plot_sens_S
plot_sens_P_8373r4 <- plot_sens_P
plot_sens_conc_combine_8373r4 <- cowplot::plot_grid(plotlist = plot_sens_conc, nrow = 2)
plot_sens_rates_combine_8373r4 <- cowplot::plot_grid(plotlist = plot_sens_rates, nrow = 3)

plot_sens_S_8373r4
plot_sens_P_8373r4
plot_sens_conc_combine_8373r4
plot_sens_rates_combine_8373r4
beep(sound=4)
```
```{r}
```
